...
import type { ChartType, ChartData, DefaultDataPoint, ChartDataset, ChartOptions, Chart } from "chart.js/auto";
 ...
 * @returns Dataset
 */
export declare function getDatasetAtEvent(chart: Chart, event: MouseEvent<HTMLCanvasElement>): import("chart.js/auto").InteractionItem[];
/**
 ...
 * @returns Dataset
 */
export declare function getElementAtEvent(chart: Chart, event: MouseEvent<HTMLCanvasElement>): import("chart.js/auto").InteractionItem[];
/**
 ...
 * @returns Dataset
 */
export declare function getElementsAtEvent(chart: Chart, event: MouseEvent<HTMLCanvasElement>): import("chart.js/auto").InteractionItem[];
