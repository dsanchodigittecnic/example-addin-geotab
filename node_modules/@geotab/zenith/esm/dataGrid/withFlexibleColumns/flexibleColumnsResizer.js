...
import { NOT_INTERACTIVE_MODIFIER } from "../dataGrid";
const MIN_COLUMN_WIDTH = 100;
export class FlexibleColumnResizer extends SimpleEventHandler {
    createResizer() {
    ...
    constructor(listRef) {
        ...
        Object.defineProperty(this, "stopResizing", {
            ...
            value: () => {
                ...
                this.listRef.classList.remove(NOT_INTERACTIVE_MODIFIER);
                this.hideResizer();
            }
        });
        ...
        Object.defineProperty(this, "startColumn", {
            ...
            value: (e) => {
                ...
                this.listRef.classList.add(NOT_INTERACTIVE_MODIFIER);
