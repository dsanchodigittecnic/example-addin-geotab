...
import { DRAGGING_MODIFIER, NOT_INTERACTIVE_MODIFIER } from "../dataGrid";
export class FlexibleColumnReorder extends SimpleEventHandler {
    createColumnToDrag() {
    ...
    constructor(list, resizer, isDraggable) {
        ...
        Object.defineProperty(this, "stopMoving", {
            ...
            value: () => {
                ...
                this.list.classList.remove(NOT_INTERACTIVE_MODIFIER);
                this.list.classList.remove(DRAGGING_MODIFIER);
                if (this.dragElt === undefined) {
                    return;
                }
                this.dragElt.remove();
        ...
        Object.defineProperty(this, "createDragElement", {
            ...
            value: () => {
                ...
                this.list.classList.add(NOT_INTERACTIVE_MODIFIER);
                this.list.classList.add(DRAGGING_MODIFIER);
