...
export const withSelectableRows = (DataGridComponent) => forwardRef(
// eslint-disable-next-line @typescript-eslint/naming-convention
function InnerList(props, ref) {
    ...
    return _jsxs(_Fragment, { children: [columns.length > 0
                ...
                : null, _jsx(DataGridComponent, Object.assign({}, props, { columns: listColumns, ref: ref }))] });
});
withSelectableRows.translations = [
    "Select menu",
    "Select all",
    "Select current page",
    "Deselect all",
