...
export class MainColumnWrapper {
    renderCell(elt, entity, isNested, isFeed) {
        ...
        const mainTextClassName = classNames(["zen-main-column__name", ((_c = this.options.mainText) === null || _c === void 0 ? void 0 : _c.className) || "", mainTextLink ? "zen-main-column__name--link" : ""]);
        const descriptionTextClassName = classNames(["zen-main-column__groups", ((_d = this.options.descriptionText) === null || _d === void 0 ? void 0 : _d.className) || ""]);
        ...
        return _jsxs("div", { className: "zen-main-column", children: [icon ? _jsx("div", { className: classNames(["zen-main-column__icon", iconParentClassName || ""]), children: icon }) : null, _jsxs("div", { className: "zen-main-column__content", children: [mainTextLink ?
                            _jsx("a", { href: mainTextLink, className: mainTextClassName, children: mainText }) :
                            _jsx("div", { className: mainTextClassName, children: mainText }), description && _jsx("div", { className: descriptionTextClassName, children: description })] }), SideItems] });
    }
    constructor(options) {
    ...
    renderIcon(entity, isNested) {
        ...
        return _jsx(PrimaryIcon, { icon: Icon, className: iconClassName, style: isNested ? "secondary" : undefined, onClick: handleOnClick, link: link, title: title, disabled: isDisabled });
    }
}
