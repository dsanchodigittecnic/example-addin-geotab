import { formatValue } from "../legend/formatValue";
        ...
        if (chart.verticalLine.enabled) {
            ...
            const items = datasets.map((dataset, dsIndex) => {
                ...
                if (value && dataset.label) {
                    ...
                    const item = {
                        label: label,
                        value: formatValue(value.toFixed(2), dsIndex, options === null || options === void 0 ? void 0 : options.unit),
