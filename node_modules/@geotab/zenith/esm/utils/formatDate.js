...
const createMonthDaysNames = (t) => {
    ...
    return {
        ...
        shortMonthNames: translate(monthNamesShort),
        shortDayNames: translate(dayNamesShort)
    };
};
export const formatDate = function (dateSource, format, translate) {
...
export const deformatDate = function (dateSource, format, translate) {
    const monthsDaysNames = createMonthDaysNames(translate);
