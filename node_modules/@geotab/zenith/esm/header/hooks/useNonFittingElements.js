...
export const useNonFittingElements = ({ maxWidth, data, hiddenElementsCountToRender, widthDelta = 0, reverseOrderOfVisible }) => {
    const elementOffset = 8;
    const hiddenContainerRef = useRef(null);
    const [visibleElements, setVisibleElements] = useState([]);
    const [nonFittingElements, setNonFittingElements] = useState([]);
    const calculateVisibleChildrenCount = useCallback((currentMaxWidth) => {
