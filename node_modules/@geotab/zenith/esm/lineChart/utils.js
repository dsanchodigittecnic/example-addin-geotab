import { hexToRGBA } from "../commonHelpers/colorUtils";
...
export const getDefaultDatasetStyle = (dataSet, dsIndex, useThinLines = false) => {
    var _a;
    ...
    newDataSet.backgroundColor = hexToRGBA(baseColor, 0.09) || "";
