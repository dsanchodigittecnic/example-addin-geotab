...
const options = {
    "Today": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_TODAY_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "Yesterday": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_YESTERDAY_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "ThisWeek": (translate, toLocalDateTime, firstDayOfWeek, toReverseOffsetDateTime) => GET_THIS_WEEK_OPTION(toLocalDateTime, translate, firstDayOfWeek, toReverseOffsetDateTime),
    "NextWeek": (translate, toLocalDateTime, firstDayOfWeek, toReverseOffsetDateTime) => GET_NEXT_WEEK_OPTION(toLocalDateTime, translate, firstDayOfWeek, toReverseOffsetDateTime),
    "LastWeek": (translate, toLocalDateTime, firstDayOfWeek, toReverseOffsetDateTime) => GET_LAST_WEEK_OPTION(toLocalDateTime, translate, firstDayOfWeek, toReverseOffsetDateTime),
    "ThisMonth": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_THIS_MONTH_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "NextMonth": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_NEXT_MONTH_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "LastMonth": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_LAST_MONTH_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "LastSevenDays": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_LAST_SEVEN_DAYS_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "LastThirtyDays": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_LAST_THIRTY_DAYS_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "LastTwelveMonths": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_LAST_TWELVE_MONTHS_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
    "LastThreeMonths": (translate, toLocalDateTime, _firstDayOfWeek, toReverseOffsetDateTime) => GET_LAST_THREE_MONTH_OPTION(toLocalDateTime, translate, toReverseOffsetDateTime),
...
export const getOptionsPeriodMap = (initialOptions, translate, toLocalDateTime, firstDayOfWeek, toReverseOffsetDateTime) => {
    const optionsArray = initialOptions.map(opt => getRangeOption(opt, translate, toLocalDateTime, firstDayOfWeek, toReverseOffsetDateTime))
        .filter(option => !!option && option.id !== CUSTOM_CALENDAR_ID);
...
export const getSelectedRangeFromValue = (optionsMap, value) => {
    if (!value) {
        return undefined;
    }
    const currentOption = optionsMap.get(`${value.from.toISOString()}_${value.to.toISOString()}`);
    if (!currentOption || value.label === CUSTOM_CALENDAR_ID) {
        return {
            label: CUSTOM_CALENDAR_ID,
            from: value.from,
            to: value.to
        };
    }
...
export const MONTH_STEP_OPTION = "month_step_option";
export const DEFAULT_STEP_OPTION = "default_step_option";
export const YEAR_STEP_OPTION = "year_step_option";
export const QUARTER_STEP_OPTION = "quarter_step_option";
export const PERIOD_ONE_DAY_STEP_OPTION = "period_one_day_step_option";
export const PERIOD_SEVEN_DAYS_STEP_OPTION = "period_seven_days_step_option";
export const PERIOD_THIRTY_DAYS_STEP_OPTION = "period_thirty_days_step_option";
export const getDateRangeAdjustedStep = (translate, label) => {
    ...
    if (monthsAdjusted.includes(label)) {
        return MONTH_STEP_OPTION;
    }
    if (quarterAdjusted.includes(label)) {
        return QUARTER_STEP_OPTION;
    }
    if (yearAdjusted.includes(label)) {
        return YEAR_STEP_OPTION;
    }
    if (periodDayAdjusted.includes(label)) {
        return PERIOD_ONE_DAY_STEP_OPTION;
    }
    if (periodSevenDaysAdjusted.includes(label)) {
        return PERIOD_SEVEN_DAYS_STEP_OPTION;
    }
    if (periodThirtyDaysAdjusted.includes(label)) {
        return PERIOD_THIRTY_DAYS_STEP_OPTION;
    }
    return DEFAULT_STEP_OPTION;
};
export const dateRangeAdjustedFn = {
    [MONTH_STEP_OPTION]: adjustDateRangeMonth,
    [YEAR_STEP_OPTION]: adjustDateRangeYear,
    [QUARTER_STEP_OPTION]: adjustDateRangeQuarter,
    [PERIOD_ONE_DAY_STEP_OPTION]: adjustDateDaysRange(1),
    [PERIOD_SEVEN_DAYS_STEP_OPTION]: adjustDateDaysRange(7),
    [PERIOD_THIRTY_DAYS_STEP_OPTION]: adjustDateDaysRange(30),
    [DEFAULT_STEP_OPTION]: adjustDateRange
};
