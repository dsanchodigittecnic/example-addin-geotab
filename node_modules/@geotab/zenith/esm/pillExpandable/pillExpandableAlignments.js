export const alignments = {
    ...
    "top-left": (triggerRect, popupRect, parentRect, paddingX, paddingY) => ({
        top: triggerRect.top - parentRect.top - popupRect.height + paddingY,
        left: triggerRect.left - parentRect.left - paddingX
    }),
    "top-right": (triggerRect, popupRect, parentRect, paddingX, paddingY) => ({
        top: triggerRect.top - parentRect.top - popupRect.height + paddingY,
        right: parentRect.right - triggerRect.right - paddingX
    }),
    "bottom": (triggerRect, popupRect, parentRect, paddingX, paddingY) => ({
    ...
    "bottom-left": (triggerRect, _1, parentRect, paddingX, paddingY) => ({
        top: triggerRect.top - parentRect.top + triggerRect.height - paddingY,
        left: triggerRect.left - parentRect.left - paddingX
    }),
