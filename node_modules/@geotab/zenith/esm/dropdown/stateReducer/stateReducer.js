...
export function stateReducer(state, action) {
    ...
    switch (type) {
        ...
        case StateActionType.UpdateNamelessItems: {
        ...
        case StateActionType.UpdateSelectedItems: {
        ...
        case StateActionType.SetPendingState: {
            return Object.assign(Object.assign({}, state), { pendingNamelessIds: payload });
        }
        case StateActionType.SetGlobalState:
        ...
        case StateActionType.SetDefaultValue: {
            const newNamelessIds = new Set(state.namelessIds);
            payload.forEach(id => {
                if (!state.groupsMapSelected.has(id)) {
                    // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
        ...
        case StateActionType.SetDefaultAllSelected: {
